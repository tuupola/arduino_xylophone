...
#define TEMPO  200      
#define HAMMER_THROW 15  /* (15) How low hammer hits. */
#define HAMMER_TIME  19  /* (19) How long hammer stays down. Can't touch this! */
#define SERVO_CENTER 119 /* (119) Starting height of the hammers. */
...
int servo_adjust[] = {-8, +8, -20, +17, -3, +17, -18, +4, -8, +15, -20, +18, +4};
int num_servos = 13;
